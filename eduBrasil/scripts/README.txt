...
#script que gera os limites para outliers da forma: media mais ou menos tres vezes o desvio padrão, classifica se a cidade esta dentro ou
fora desse limite e gera um arquivo de saida contendo todos os indicadores e a classificação para todas as cidades.
