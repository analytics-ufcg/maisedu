...
agregaMedianas = function(data) {
  tabela = rbind(calcMedian(data,"NOME_UF"), calcMedian(data,"NOME_MESO"), calcMedian(data,"NOME_MICRO"))
  return(tabela)
}
...
#salva data frame
write.csv(dffinal, "medianas_para_todos_os_indicadores_agrupados_por_ano_e_regiao.csv")
