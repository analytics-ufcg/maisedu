...
#Leitura de arquivos
desvios = read.csv("Indicadores Selecionados/tabela_com_todos_os_indicadores_selecionados_e_desvios.csv",fileEncoding="latin1")
regioes = read.csv("Indicadores Selecionados/medianas_para_todos_os_indicadores_agrupados_por_ano_e_regiao.csv",fileEncoding="latin1")
...
criaImagem = function(valor,indicador,codigo,dp){
	...
	png(paste(codigo,"_",indicador,"_",desv,".png", sep=""),width = 382, height = 291)
