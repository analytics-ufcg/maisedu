...
var lista_cidades = ["Campina Grande", "Alagoinha", "Alagoa Grande","Mulungu","Itabaiana","Alagoa Nova","Areia","Patos","Souza","Bananeiras","Alagoinha","Arara"];
...
function path(d) {
	var tmp = line(dimensions.map(function(p) { return [position(p), y[p](d[p])]; }));
	//tmp.attr("stroke-width", 20);
  return tmp;
}
